...
const Sponsored = () => {
  return (
    <div
      className={`${styles.section} hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)]`}
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://logodownload.org/wp-content/uploads/2014/09/msi-logo-2.png"
            style={{width:"150px", objectFit:"contain"}}
            alt=""
          />
        </div>
